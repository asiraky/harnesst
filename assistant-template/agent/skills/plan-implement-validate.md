...
checkout identity, exact configured model, authorization limits, and cleanup state. Do not replace
it with `npx eve eval` in bash or expose model/provider secrets to the checkout.
